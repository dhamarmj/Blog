        ...
        <div class="col-lg-8 col-md-10 mx-auto">
            <#list list as articulo>
                <div class="post-preview">
                    ...
                    <h5 class="post-subtitle">${articulo.getTeaser()}</h5>
                    <p class="post-meta"> ${articulo.getStringEtiqueta()}</p>
                <#if currentUser.getId()??>
                    <#if currentUser.getId() == ${articulo.getAutor()} || currentUser.isAdmin()>
                        <#--<div class="clearfix">-->
                            <#--<a class="btn btn-danger float-right" href="#">Borrar</a>-->
                            <#--<a class="btn btn-info float-right" href="#">Modificar</a>-->
                        <#--</div>-->
                    </#if>
                </#if>
                </div>
