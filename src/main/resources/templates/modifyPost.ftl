            ...
            <form name="sentMessage" id="contactForm" method="post" action="/updateArticle/${articulo.getId()}">
                <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        <label>Title</label>
                        <input type="text" class="form-control" value="${articulo.titulo}"  name="title" required data-validation-required-message="Please enter your name.">
                ...
                <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        <label>Cuerpo</label>
                        <textarea rows="5" class="form-control" name="body" required data-validation-required-message="Please enter a message.">${articulo.texto}</textarea>
                        <p class="help-block text-danger"></p>
                    </div>
                </div>
                <div class="control-group">
